export default () => {
  return (
    <div className="rounded-md shadow-sm my-4 dark:shadow-cullen-800">
      <div className="flex flex-row h-full">
        ...
        <div className="self-center">
          <h1 className="font-semibold">
            ...
            <a target="_blank" href="https://www.asyncapi.com/" className="text-cyan-500 underline hover:text-cyan-600">
              AsyncAPI
            </a>.
          </h1>
        </div>
